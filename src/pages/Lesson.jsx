...
const Lesson = () => {
    ...
    return (
		<div className="mt-5">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[90%] mx-auto gap-7 mb-7">{lessons.map((lesson) => lesson.lesson_no == lesson_no && <LessonCard lesson={lesson}></LessonCard>)}</div>
