	...
	return (
		<div className="w-[95%] mx-auto mb-15 bg-[#F9FAFB] rounded-2xl">
			<div className="grid grid-cols-1 lg:grid-cols-2 p-5">
				<div>
					<h1 className="text-[30px] mb-3 md:text-[40px] md:mb-6 font-bold w-full md:w-[80%] text-[#3D348B] animate__animated animate__wobble">Learn German the Smarter Way</h1>
